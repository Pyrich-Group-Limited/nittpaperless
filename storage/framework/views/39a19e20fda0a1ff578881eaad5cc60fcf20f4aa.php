...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-bs-toggle="modal" data-bs-target="#publishAdvertModal" id="toggleOldProject" wire:click="selProject2(<?php echo e($project); ?>)"  data-bs-toggle="tooltip" title="<?php echo e(__('Advertise Project')); ?>"  class="btn btn-sm btn-primary">
            <i class="ti ti-share"></i>
        </a>

        <a href="#" data-size="lg" data-bs-toggle="modal" data-bs-target="#editProject" id="toggleOldProject"  wire:click="selProject(<?php echo e($project->id); ?>)"  data-bs-toggle="tooltip" title="<?php echo e(__('Modify Project')); ?>"  class="btn btn-sm btn-primary">
