                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        <a href="#" class="action-item" data-url="<?php echo e(route('contract.description',$contract->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Description')); ?>" data-title="<?php echo e(__('Description')); ?>"><i class="fa fa-comment"></i></a>
                                    </td>
                                    ...
                                    <td class="action ">
                                        ...
                                        <?php if(\Auth::user()->type=='super admin'): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view contract')): ?>
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/projects/project-contracts-component.blade.php ENDPATH**/ ?>