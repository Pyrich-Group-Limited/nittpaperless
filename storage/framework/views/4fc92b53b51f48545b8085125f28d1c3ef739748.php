...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('jobber.index')); ?>"><?php echo e(__('Contract')); ?></a></li>
...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(array('url'=>'jobbber','method'=>'post'))); ?>

    <div class="row mt-3">
        <div class="col-md-6 ">
            <div class="card card-fluid">
                <div class="card-body jobber-create">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <?php echo Form::label('title', __('Contract Title'),['class'=>'form-label']); ?>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo Form::label('category', __('Cotract Category'),['class'=>'form-label']); ?>
        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <?php echo Form::label('sescription', __('Contract Description'),['class'=>'form-label']); ?>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-6 mb-2">
                            <?php echo Form::label('requirement', __('Cotract Requirement'),['class'=>'form-label']); ?>
