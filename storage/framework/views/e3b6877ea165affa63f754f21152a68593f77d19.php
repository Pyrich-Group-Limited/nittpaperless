            ...
            <div class="card-body">
                ...
                <div class="card bg-primary mb-0">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <span class="text-white text-sm"><?php echo e(__('Contractor')); ?></span>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><b>VAT(7.5%)</b></td>
                                    <td> <b><?php echo e(number_format(7.5/100 * ($totalSum))); ?></b> </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><b>SUM TOTAL</b></td>
                                    <td> <b><?php echo e(number_format((7.5/100 * ($totalSum)) + $totalSum)); ?></b> </td>
                                </tr>
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                        ...
                        id="toggleUploadProjectUser" data-bs-toggle="tooltip" title="<?php echo e(__('Add Member')); ?>"
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/physical-planning/projects/physical-planning-project-detials.blade.php ENDPATH**/ ?>