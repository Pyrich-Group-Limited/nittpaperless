        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <div class=" btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                    ...
                    <label
                        class="btn bg-primary p-3 <?php echo e($event->color == 'event-success' ? 'custom_color_radio_button' : ''); ?>"><input
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/nittpaperless/resources/views/event/edit.blade.php ENDPATH**/ ?>