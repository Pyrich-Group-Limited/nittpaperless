...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="modal-footer">
                ...
                <input type="button" wire:click="registerUser" value="<?php echo e(__('Update')); ?>" class="btn  btn-primary">
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp-server\htdocs\nittpaperless\resources\views/livewire/users/edit-user-component.blade.php ENDPATH**/ ?>