<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Delivered Supply')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('deliveredSupply.list')); ?>"><?php echo e(__('Delivered Supplys ')); ?></a></li>
<?php $__env->stopSection(); ?>
                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="<?php echo e(route('deliveredSupply.details')); ?>" class="mx-3 btn btn-sm align-items-center"
