...
<?php $__env->startSection('content'); ?>
    ...
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('user.new-user-component')->html();
} elseif ($_instance->childHasBeenRendered('vA4Q1u5')) {
    $componentId = $_instance->getRenderedChildComponentId('vA4Q1u5');
    $componentTag = $_instance->getRenderedChildComponentTagName('vA4Q1u5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vA4Q1u5');
} else {
    $response = \Livewire\Livewire::mount('user.new-user-component');
    $html = $response->html();
    $_instance->logRenderedChild('vA4Q1u5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
