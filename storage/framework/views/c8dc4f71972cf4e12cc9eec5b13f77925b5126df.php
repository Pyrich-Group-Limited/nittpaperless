...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="row">
                <?php if($thisMonthfiles->isNotEmpty()): ?>
                ...
                <div align="center" id="norecord"><img style="margin-left:;"  width="100" src="https://img.freepik.com/free-vector/
                    ...
                    <p class="mt-2 text-danger">No files found!</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nittpaperless\resources\views/filemanagement/this-month-files.blade.php ENDPATH**/ ?>