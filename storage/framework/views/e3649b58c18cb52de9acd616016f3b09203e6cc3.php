<div>
    ...
    <?php $__env->startSection('page-title'); ?>
        <?php echo e(__('Manage Contractors')); ?>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body full-card">
                                <div class="img-fluid rounded-circle card-avatar">
                                    <img src="<?php echo e((!empty($client->avatar))? asset(Storage::url("uploads/avatar/".$client->avatar)): asset("uploads/user.png")); ?>" alt="kal" class="img-user wid-80 rounded-circle">
                                </div>
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/projects/project-contractors-component.blade.php ENDPATH**/ ?>