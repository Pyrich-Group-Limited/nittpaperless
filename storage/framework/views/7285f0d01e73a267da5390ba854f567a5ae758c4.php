                    ...
                    <div class="modal-body">
                        <?php if($selApplicant): ?>
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="white-space: pre-wrap"><?php echo e($selApplicant->applicant->year_of_incorporation); ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge <?php if($selApplicant->application_status=='pending'): ?> bg-warning
                                                            ...
                                                            <?php elseif($selApplicant->application_status=='rejected'): ?> bg-danger
                                                            <?php endif; ?> p-2 px-3 rounded"><?php echo e($selApplicant->application_status); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(date('d-M-Y', strtotime($selApplicant->created_at))); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <div wire:loading wire:target="recommendToDg"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?></div>
                                ...
                                <?php if($selApplicant->application_status!='selected'): ?>
                                    <input type="button"  wire:click="recommendToDg('<?php echo e($selApplicant->id); ?>')" value="<?php echo e(__('Recommend')); ?>" class="btn  btn-primary">
                                <?php endif; ?>
                            </div>
                        <?php else: ?>
