                                                ...
                                                <?php if($key < count($account['account']) - 1): ?>
                                                    <?php if(!preg_match('/\btotal\b/i', $record['account_name'])): ?>
                                                        <div
                                                            ...
                                                            <p class="mb-2"><a
                                                                    href="<?php echo e(route('chart-of-account.show', $record['account_id'])); ?>?account=<?php echo e($record['account_id']); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/nittpaperless/resources/views/report/balance_sheet.blade.php ENDPATH**/ ?>