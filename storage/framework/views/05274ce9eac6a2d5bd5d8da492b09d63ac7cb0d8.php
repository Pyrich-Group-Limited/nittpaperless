...
} elseif ($_instance->childHasBeenRendered('l3177822099-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3177822099-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3177822099-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3177822099-0');
} else {
    $response = \Livewire\Livewire::mount('physical-planning.projects.uploadboq');
    $html = $response->html();
    $_instance->logRenderedChild('l3177822099-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
