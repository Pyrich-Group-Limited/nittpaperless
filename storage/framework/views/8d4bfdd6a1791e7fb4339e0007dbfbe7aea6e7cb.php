                            ...
                            <?php if($selProject): ?>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="project_name" value="<?php echo e($selProject->project_name); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php $__currentLoopData = $inputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row mb-2">
                                        <div class="col-md-3">
                                            <input type="text"
                                                <?php $__errorArgs = ['inputs.' . $key . '.item'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                id="input_<?php echo e($key); ?>_item"
                                                id="input_<?php echo e($key); ?>_item" placeholder="Item"
                                                wire:model.defer="inputs.<?php echo e($key); ?>.item"
                                                class="form-control" />
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text"
                                                <?php $__errorArgs = ['inputs.' . $key . '.description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> style="border-color: red" <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                id="input_<?php echo e($key); ?>_description"
                                                id="input_<?php echo e($key); ?>_description" placeholder="Description"
                                                wire:model.defer="inputs.<?php echo e($key); ?>.description"
                                                class="form-control" />
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text"
                                                <?php $__errorArgs = ['inputs.' . $key . '.unit_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> style="border-color: red" <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-2">
                                            <input type="text"
                                                <?php $__errorArgs = ['inputs.' . $key . '.quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> style="border-color: red" <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                id="input_<?php echo e($key); ?>_quantity"
                                                id="input_<?php echo e($key); ?>_quantity" placeholder="Quantity"
                                                wire:model="inputs.<?php echo e($key); ?>.quantity"
                                                class="form-control" />
                                        </div>
                                        <div class="col-md-1">
                                            <?php if($key > 0): ?>
                                                <a href="#" wire:click="removeInput(<?php echo e($key); ?>)"
                                                    data-bs-toggle="tooltip" title="<?php echo e(__('Add Field')); ?>"
                                ...
                                <a href="#" wire:click="addInput" data-bs-toggle="tooltip"
                                    title="<?php echo e(__('Add Field')); ?>" class="btn btn-sm btn-primary mt-3">
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-auto mb-3 mb-sm-0">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <small class="text-muted"><?php echo e(__('SUB')); ?></small>
                                                    <h6 class="m-0"><?php echo e(__('TOTAL')); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" wire:click="uploadBOQ" value="<?php echo e(__('Uplaod Bill of Quantity')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/physical-planning/projects/uploadboq.blade.php ENDPATH**/ ?>