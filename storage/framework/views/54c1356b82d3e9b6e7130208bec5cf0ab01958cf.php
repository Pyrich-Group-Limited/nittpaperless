                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <div class="table-head col-xl-12 mt-2" style="text-align: right;">
                            <a href="#" class="btn btn-primary" data-url="<?php echo e(route('storeVoucher.add')); ?>" data-ajax-popup="true"  data-size="lg " data-bs-toggle="tooltip"><i class="ti ti-plus text-white"></i>Add New</a>
                        </div>
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Section/Unit')); ?></th>
                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="<?php echo e(route('storeVoucher.details')); ?>" class="mx-3 btn btn-sm align-items-center"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/nittpaperless/resources/views/accountant/store-issue-voucher.blade.php ENDPATH**/ ?>