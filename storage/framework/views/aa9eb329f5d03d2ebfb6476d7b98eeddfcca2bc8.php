                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <div class="form-group">
                                        <?php echo e(Form::select('account', $accounts,'', array('class' => 'form-control select js-searchBox','id'=>'choices-multiple1','required'=>'required'))); ?>
