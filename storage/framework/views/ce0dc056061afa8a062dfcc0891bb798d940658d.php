...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create job')): ?>
            <a href="<?php echo e(route('jobber.create')); ?>" class="btn btn-sm btn-primary"  data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Contracts')); ?>">
                        ...
                        <div class="col-auto mb-3 mb-sm-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="m-0"><?php echo e(__('Contracts')); ?></h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $jobbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($job->status!='in_active'): ?>
                                                ...
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="#" id="<?php echo e(route('jobber.requirement',[$job->code,!empty($job)?$job->createdBy->lang:'en'])); ?>" class="mx-3 btn btn-sm align-items-center"  onclick="copyToClipboard(this)" data-bs-toggle="tooltip" title="<?php echo e(__('Copy')); ?>" data-original-title="<?php echo e(__('Click to copy')); ?>"><i class="ti ti-link text-white"></i></a>
                                                </div>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show job')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="<?php echo e(route('jobber.show',$job->id)); ?>" data-title="<?php echo e(__('Job Detail')); ?>" title="<?php echo e(__('View')); ?>"  class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>">
                                                        <i class="ti ti-eye text-white"></i></a>
                                                </div>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit job')): ?>
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="<?php echo e(route('jobber.edit',$job->id)); ?>" data-title="<?php echo e(__('Edit Job')); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
                                                        <i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete job')): ?>
                                                <div class="action-btn bg-danger ms-2">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['jobber.destroy', $job->id],'id'=>'delete-form-'.$job->id]); ?>
