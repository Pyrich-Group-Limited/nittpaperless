...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create job')): ?>
            <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#publishAdvertModal"  data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Job')); ?>">
                ...
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            <h4 class="m-0"><?php echo e(count($totalProjects)); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            <h4 class="m-0"><?php echo e(count($totalProjects->where('status','Pending') )); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            <h4 class="m-0"><?php echo e(count($totalProjects->where('status','Completed') )); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo Str::limit(strip_tags($project->description),120); ?></td>
                                    <td><?php echo e(\Auth::user()->dateFormat($project->start_date)); ?></td>
                                    <td><?php echo e(\Auth::user()->dateFormat($project->end_date)); ?></td>
                                    <td>
                                        <?php if($job->status=='active'): ?>
                                            <span class="status_badge badge bg-success p-2 px-3 rounded"><?php echo e($project->status); ?></span>
                                        <?php else: ?>
                                            <span class="status_badge badge bg-danger p-2 px-3 rounded"><?php echo e($project->status); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e(\Auth::user()->dateFormat($project->created_at)); ?></td>
                                    <?php if( Gate::check('edit job') ||Gate::check('delete job') || Gate::check('show job')): ?>
                                        <td>
...
<?php /**PATH C:\xampp-server\htdocs\nittpaperless\resources\views/livewire/procurements/projects/procurement-projects-component.blade.php ENDPATH**/ ?>