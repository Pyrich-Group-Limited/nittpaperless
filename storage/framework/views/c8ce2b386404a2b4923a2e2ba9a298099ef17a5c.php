                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th> <?php echo e(__('Journal Balance')); ?></th>
                                    <th> <?php echo e(__('Transaction Balance')); ?></th>
                                ...
                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(route('chart-of-account.show',$account->id)); ?>?account=<?php echo e($account->id); ?>"><?php echo e($account->name); ?></a></td>
                                        ...
                                        <td>
                                            <?php if($account->is_enabled==1): ?>
                                                <span class="badge bg-primary p-2 px-3 rounded"><?php echo e(__('Enabled')); ?></span>
                                            <?php else: ?>
                                        ...
                                        <td class="Action">
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="<?php echo e(route('chart-of-account.show',$account->id)); ?>?account=<?php echo e($account->id); ?>" class="mx-3 btn btn-sm align-items-center " data-bs-toggle="tooltip" title="<?php echo e(__('Transaction Summary')); ?>" data-original-title="<?php echo e(__('Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/nittpaperless/resources/views/chartOfAccount/index.blade.php ENDPATH**/ ?>