<div class="">
    <form action="<?php echo e(route('files.rename',$file->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-body">
            <div class="row">
                    ...
                    <div class="card text-center card-2">
                        <div class="card-body full-card">
                            <div class="img-fluid rounded-circle card-avatar">
                                ...
                                <h6 class=" mt-4 text-primary"><?php echo e($file->file_name); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo e($file->file_name); ?>" name="filename" class="form-control" required>
                </div>
        ...
        <div class="modal-footer">
            ...
            <input type="submit" value="<?php echo e(__('Rename File')); ?>" class="btn  btn-primary">
        </div>
    </form>
</div>
...
<?php /**PATH C:\xampp\htdocs\nittpaperless\resources\views/filemanagement/modals/rename-file.blade.php ENDPATH**/ ?>