...
} elseif ($_instance->childHasBeenRendered('IRjNdop')) {
    $componentId = $_instance->getRenderedChildComponentId('IRjNdop');
    $componentTag = $_instance->getRenderedChildComponentTagName('IRjNdop');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IRjNdop');
} else {
    $response = \Livewire\Livewire::mount('user.new-user-component');
    $html = $response->html();
    $_instance->logRenderedChild('IRjNdop', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
