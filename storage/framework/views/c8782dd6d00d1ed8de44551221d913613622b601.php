...
} elseif ($_instance->childHasBeenRendered('l2206957434-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2206957434-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2206957434-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2206957434-0');
} else {
    $response = \Livewire\Livewire::mount('physical-planning.projects.uploadboq');
    $html = $response->html();
    $_instance->logRenderedChild('l2206957434-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/projects/projects-component.blade.php ENDPATH**/ ?>