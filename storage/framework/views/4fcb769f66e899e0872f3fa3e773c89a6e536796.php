        ...
        <div class="row">
         <?php echo csrf_field(); ?>
            ...
            <div class="form-control" >
                ...
                <input type="hidden" <?php if(Auth::user()->type == 'super admin'): ?>name="company_signature" <?php elseif(Auth::user()->type == 'client' ): ?> name="client_signature" <?php endif; ?> id="SignupImage1">
            </div>
            <div class="mt-1">
...
<?php /**PATH /var/www/html/nittpaperless/resources/views/contract/signature.blade.php ENDPATH**/ ?>