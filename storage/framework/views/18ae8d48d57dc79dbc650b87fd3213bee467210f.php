...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
            <a href="#" data-size="lg" data-bs-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#uploadBOQModal" title="<?php echo e(__('Upload Bill of Quantity')); ?>" class="btn btn-sm btn-primary">
