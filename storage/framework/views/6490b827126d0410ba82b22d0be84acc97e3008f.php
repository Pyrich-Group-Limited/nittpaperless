...
} elseif ($_instance->childHasBeenRendered('l2135328907-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2135328907-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2135328907-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2135328907-0');
} else {
    $response = \Livewire\Livewire::mount('physical-planning.projects.uploadboq');
    $html = $response->html();
    $_instance->logRenderedChild('l2135328907-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

<div>
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/physical-planning/projects/physical-planning-projects-component.blade.php ENDPATH**/ ?>