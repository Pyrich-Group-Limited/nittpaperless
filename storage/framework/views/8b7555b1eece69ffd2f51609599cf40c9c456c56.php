                        ...
                        <div class="card text-center card-2">
                            ...
                            <div class="card-body full-card">
                                <div class="img-fluid rounded-circle card-avatar">
                                    ...
                                    <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): (asset("assets/images/user/avatar.png"))); ?>"  class="img-user wid-80 rounded-circle">
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-NITT-2\resources\views/user/index.blade.php ENDPATH**/ ?>