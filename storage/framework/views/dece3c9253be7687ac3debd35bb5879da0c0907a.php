...
} elseif ($_instance->childHasBeenRendered('l645345172-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l645345172-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l645345172-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l645345172-0');
} else {
    $response = \Livewire\Livewire::mount('physical-planning.projects.uploadboq');
    $html = $response->html();
    $_instance->logRenderedChild('l645345172-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
