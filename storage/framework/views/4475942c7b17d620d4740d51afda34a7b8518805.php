...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('designation_id', $designations, null,array('class' => 'form-control select','required'=>'required')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('branch_id', $branchs, null,array('class' => 'form-control select','required'=>'required')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('department_id', $departments, null,array('class' => 'form-control select','required'=>'required')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('unit_id', $units, null,array('class' => 'form-control select','required'=>'required')); ?>
