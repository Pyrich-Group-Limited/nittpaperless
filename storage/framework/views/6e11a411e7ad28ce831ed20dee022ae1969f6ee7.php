            ...
            <?php if(\Auth::user()->type != 'client'): ?>
                <ul class="dash-navbar">
                    ...
                    <?php if( Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext"><?php echo e(__('Assets/Store')); ?></span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="dash-submenu">
                                <?php if(Gate::check('manage product & service')): ?>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productservice')?'active':''); ?>">
                                        <a href="<?php echo e(route('productservice.index')); ?>" class="dash-link"><?php echo e(__('Store & Services')); ?>
                                ...
                                <?php if(Gate::check('manage product & service')): ?>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productstock')?'active':''); ?>">
                                        <a href="<?php echo e(route('productstock.index')); ?>" class="dash-link"><?php echo e(__('Store Stock')); ?>
                    ...
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'procurement-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-procurement"></i></span><span class="dash-mtext"><?php echo e(__('e-Procurement')); ?></span>
                        </a>
                    </li>

                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'business-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext"><?php echo e(__('BIS Development')); ?></span></a>
                    </li>
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'supply-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext"><?php echo e(__('SCMS Development')); ?></span></a>
                    </li>
                    
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'marketing-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext"><?php echo e(__('MRM Module')); ?></span></a>
                    </li>
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'planning-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext"><?php echo e(__('DAP System')); ?></span></a>
                    </li>
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'risk-templates')?'active':''); ?>">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext"><?php echo e(__('DIRM System')); ?></span></a>
                    </li>
                        ...
                        <div class="d-flex align-items-center py-3 px-3 border-bottom">
                            <div class="me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="30" viewBox="0 0 29 30" fill="none">
                                    <circle cx="14.5" cy="15.1846" r="14.5" fill="#0C7885"></circle>
