<div>
    ...
    <?php $__env->startSection('action-btn' ); ?>
        <div class="float-end">
            ...
            <?php elseif($project->project_boq != null && $project->advert_approval_status == true): ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="float-end">
                            <?php if($project->project_boq != null && $project->advert_approval_status == false): ?>
                                <button wire:click="approve('<?php echo e($project->id); ?>')" class="btn btn-primary btn-sm">
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/livewire/d-g/dg-project-details-component.blade.php ENDPATH**/ ?>