...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('designation', $roles, null,array('class' => 'form-control select','required'=>'required')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('location', $roles, null,array('class' => 'form-control select','required'=>'required')); ?>
...
<?php /**PATH C:\xampp\htdocs\e-NITT-2\resources\views/user/create.blade.php ENDPATH**/ ?>