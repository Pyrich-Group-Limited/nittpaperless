...
<script type="text/javascript">
  ...
  $(document).on("click", "#pay_with_razorpay", function () {
    ...
    <?php if($company_payment_setting['is_payfast_enabled'] == 'on' && !empty($company_payment_setting['payfast_merchant_id']) && !empty($company_payment_setting['payfast_merchant_key'])): ?>
...
<?php /**PATH C:\xampp\htdocs\nittpaperless-1\resources\views/invoice/customer_invoice.blade.php ENDPATH**/ ?>