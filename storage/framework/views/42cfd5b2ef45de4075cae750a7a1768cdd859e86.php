                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center justify-content-between">
                                                <div class="col-auto mb-3 mb-sm-0">
                                                    <a href="<?php echo e(route('approvedSupply.list')); ?>">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                ...
                                                                <h6 class="m-0"><?php echo e(__('Approved Supply')); ?></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row align-items-center justify-content-between">
                                                <div class="col-auto mb-3 mb-sm-0">
                                                    <a href="<?php echo e(route('deliveredSupply.list')); ?>">
                                                        <div class="d-flex align-items-center">
                                                            <div class="theme-avtar bg-primary">
                                                                <i class="ti ti-cast"></i>
                                                            </div>
                                                            <div class="ms-3">
                                                                <h6 class="m-0"><?php echo e(__('Supply Delivered')); ?></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
