<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage DTA Report')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('DTA Report')); ?></li>
<?php $__env->stopSection(); ?>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-0"><?php echo e(__('Approved DTA')); ?> </h5>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-0"><?php echo e(__('Rejected DTA')); ?></h5>
                                    <p class="text-muted text-sm mb-0">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-0"><?php echo e(__('Pending DTA')); ?></h5>
                        ...
                        <div class="table-responsive py-4">
                            <table class="table mb-0" id="report-dataTable">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(__('Approved DTA')); ?></th>
                                    <th><?php echo e(__('Rejected DTA')); ?></th>
                                    <th><?php echo e(__('Pending DTA')); ?></th>
                                </tr>
                                </thead>
                                <tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nittpaperless\resources\views/dta/reports.blade.php ENDPATH**/ ?>