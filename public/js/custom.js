...
$(document).on("click", '.confirm-application', function () {
    var form = $(this).closest("form");
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
            confirmButton: 'btn btn-success',
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            ...
            Livewire.emit('application-confirmed');
...
$(document).on("click", '.confirm-reset-code', function () {
    var form = $(this).closest("form");
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
            confirmButton: 'btn btn-success',
    ...
    swalWithBootstrapButtons.fire({
        title: 'Are you sure?',
        text: "you want to reset staff secret code?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes',
        cancelButtonText: 'No',
        ...
        if (result.isConfirmed) {
            ...
            Livewire.emit('reset-code-confimred');
...
$(document).on("click", '.confirm-close', function () {
    ...
    swalWithBootstrapButtons.fire({
        title: 'Are you sure?',
        text: "You want to update budget status to close?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes',
        cancelButtonText: 'No',
...
$(document).on("click", '.confirm-open', function () {
    ...
    swalWithBootstrapButtons.fire({
        title: 'Are you sure?',
        text: "You want to update budget status to open?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes',
        cancelButtonText: 'No',
