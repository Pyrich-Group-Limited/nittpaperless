...
class ContractorContractDetailsComponent extends Component
{
    public $contract_id;
    ...
    public function render()
    {
        ...
        return view('livewire.contractor.contractor-contract-details-component',compact('contract'))->layout('layouts.contractor');
    }
}
