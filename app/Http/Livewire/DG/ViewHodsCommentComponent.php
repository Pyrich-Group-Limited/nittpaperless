...
class ViewHodsCommentComponent extends Component
{
    public $project_id;
    // public $commentText;
    ...
    {
        $comments = ProjectComment::where('project_creation_id', $this->project_id)->get();
        // dd($comments);
        $project = ProjectCreation::find($this->project_id);
        return view('livewire.d-g.view-hods-comment-component',compact('project','comments'));
    }
}
