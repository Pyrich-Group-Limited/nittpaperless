...
//    }
    ...
    public static $chartOfAccount = array(
        ...
        [
            'code' => '11',
            'name' => 'GOVERNMENT SHARE OF FAAC (STATUTORY REVENUE)',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '110102',
            'name' => 'FEDERAL GOVERNMENT SHARE OF VAT',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '110103',
            'name' => 'FEDERAL GOVERNMENT SHARE OF EXCESS CRUDE ACCOUNT',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '120207',
            'name' => 'EARNINGS -GENERAL',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '120208',
            'name' => 'RENT ON GOVERNMENT BUILDINGS - GENERAL',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '120209',
            'name' => 'RENT ON LAND & OTHERS - GENERAL',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '1401',
            'name' => 'TRANSFER FROM CONSOLIDATED REVENUE FUND TO CDF',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140201',
            'name' => 'OTHER CAPITAL RECEIPTS',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '140401',
            'name' => 'FOREIGN DEBT FORGIVENESS',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140402',
            'name' => 'DOMESTIC DEBT FORGIVENESS',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '140501',
            'name' => 'GAIN ON DISPOSAL OF ASSET - PPE',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140502',
            'name' => 'GAIN ON DISPOSAL OF ASSET - INVESTMENT PROPERTY',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140503',
            'name' => 'GAIN ON DISPOSAL OF ASSET - INTANGIBLE',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '1406',
            'name' => 'MINORITY INTEREST SHARE OF SURPLUS',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '1408',
            'name' => 'GAIN ON SWAPPED ASSETS',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140801',
            'name' => 'GAIN ON SWAPPED ASSETS - PPE',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140802',
            'name' => 'GAIN ON SWAPPED ASSETS - INVESTMENT PROPERTY',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
            'code' => '140803',
            'name' => 'GAIN ON SWAPPED ASSETS - INTANGIBLE',
            'type' => 1,
            'sub_type' => 2,
        ],
        [
            'code' => '140804',
            'name' => 'GAIN ON SWAPPED ASSETS - INVENTORY',
            'type' => 1,
            'sub_type' => 2,
        ],
        [
            'code' => '1409',
            'name' => 'GAIN ON SWAPPED SERVICES',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
        ...
        [
            'code' => '1501',
            'name' => 'TRANSFER TO FUND RECURRENT EXPENDITURE-RECEIPT',
            'type' => 1,
            'sub_type' => 1,
        ],
        [
