...
<head>
    <title>{{ $title ?? 'NITT e-Procurment' }}</title>
    ...
    <meta property="og:title" content="{{ $title ?? 'Nigeria Institute of Transport Technology' }}">
    <meta property="og:description"  content="{{ $description ?? 'The leading Transport and Logistics Development Institute in Nigeria and the entire West African sub-region, setting the standard for excellence and innovation in the industry' }}">
    ...
    <meta property="twitter:title" content="{{ $title ?? 'Nigeria Institute of Transport Technology' }}">
    <meta property="twitter:description"  content="{{ $description ?? 'The leading Transport and Logistics Development Institute in Nigeria and the entire West African sub-region, setting the standard for excellence and innovation in the industry' }}">
    ...
    <meta name="google:description" content="{{ $description ?? 'The leading Transport and Logistics Development Institute in Nigeria and the entire West African sub-region, setting the standard for excellence and innovation in the industry' }}">
    <meta name="google:title" content="{{ $title ?? 'Nigeria Institute of Transport Technology' }}">
    <meta name="google:image" content="{{ $logo ?? asset('guest/images/meta-logo.png') }}">

    <meta name="description" content="{{ $description ?? 'The leading Transport and Logistics Development Institute in Nigeria and the entire West African sub-region, setting the standard for excellence and innovation in the industry' }}" />
    ...
    <div class="zmm-wrapper">
        ...
        <div class="zmm-inner bg-white typo-dark">
            <div class="text-center mobile-logo-part margin-bottom-30">
                 <a href="{{ route('welcome')}}" class="img-before"><img src="{{ asset('logo-dark.png') }}" class="img-fluid" width="170" height="51" alt="Logo"></a>
            </div>
