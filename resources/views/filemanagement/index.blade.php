...
{{-- @section('action-btn')
    <div class="float-end">
        <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm"
            data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Upload Files') }}"><i class="ti ti-upload"></i>Upload
        </a>
        <a href="#" data-size="lg" data-url="{{ route('users.create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create Folder')}}"  class="btn btn-sm btn-primary">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="#!" data-size="lg" data-url="{{ route('file.upload') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Upload File')}}">
