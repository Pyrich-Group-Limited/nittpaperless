...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ route('folders.index') }}" class="btn btn-primary btn-sm"><<< Back to Main Folders</a>
            <hr>
        </div>
    </div>
            ...
            <div class="desktop">
                @if ($subfolders->count() > 0)
                    @foreach ($subfolders as $subfolder)
                        <div class="folder" style="margin-left: 20px;" data-id="{{ $subfolder->id }}" draggable="true">
                            <div class="folder-icon">
                                <a href="{{ route('folders.display', $subfolder->id) }}">
                            ...
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="#!" data-size="md" data-url="{{ route('folder.renameModal', $subfolder->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{ __('Rename Folder') }}">
                                        <i class="ti ti-pencil"></i>
                                        <span>{{ __('Rename') }}</span>
                                    </a>
                                    <a href="{{ route('folder.details', $subfolder->id) }}" class="dropdown-item">
                                        <i class="ti ti-eye"></i>
         ...
         {{-- <div class="pagination-links mt-4">
                <nav>
                    <ul class="pagination justify-content-center">
                        @foreach ($subfolders->links()->elements[0] as $page => $url)
                            <li class="page-item{{ $page == $subfolders->currentPage() ? ' active' : '' }}">
