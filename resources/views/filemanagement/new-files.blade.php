...
@endphp
@section('page-title')
    {{__('Documents Created in the Last 7 Days')}}
@endsection
@push('script-page')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Documents Created in the Last 7 Days')}}</li>
@endsection
            ...
            <div class="row">
                ...
                @else
                    ...
                    <div align="center" id="norecord"><img style="margin-left:;"  width="100" src="https://img.freepik.com/free-vector/
                        ...
                        <p class="mt-2 text-danger">No recent Documents found!</p>
                    </div>
                @endif
            </div>
        </div>
