...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('jobber.index')}}">{{__('Contract')}}</a></li>
...
@endsection
@section('content')
    {{Form::open(array('url'=>'jobbber','method'=>'post'))}}
    <div class="row mt-3">
        <div class="col-md-6 ">
                ...
                <div class="card-body jobber-create">
                    <div class="row">
                        <div class="form-group col-md-12">
                            {!! Form::label('title', __('Contract Title'),['class'=>'form-label']) !!}
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('category', __('Cotract Category'),['class'=>'form-label']) !!}
        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            {!! Form::label('sescription', __('Contract Description'),['class'=>'form-label']) !!}
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-6 mb-2">
                            {!! Form::label('requirement', __('Cotract Requirement'),['class'=>'form-label']) !!}
                        </div>
