<div>
    @section('page-title')
        DTA Request for Cash Office Approval.
    @endsection
    @section('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
        <li class="breadcrumb-item">{{__('DTA for Approval.')}}</li>
    @endsection
    @push('css-page')
        <style>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="tab-content" id="myTabContent3" wire:ignore.self>
                                    <div class="tab-pane fade fade show active table-responsive" id="pendingDtas"
                                                            ...
                                                            <td>
                                                                ...
                                                                @if($dtaRequest->status != 'pending')
                                                                    @can('final account approve') 
                                                                        ...
                                                                        onclick="window.open('{{ route('dta.voucher', $dtaRequest->id) }}','popup', 'width=994, height=1123')">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @if($approvedDtaRequest->status != 'pending')
                                                                    @can('final account approve') 
                                                                        <button class="btn btn-success btn-sm" type="submit" target="popup" 
                                                                        onclick="window.open('{{ route('dta.voucher', $approvedDtaRequest->id) }}','popup', 'width=994, height=1123')">
                                                                        <i class="fa fa-print"></i> View Voucher
                                                                        </button>
                                                                    @endcan
                                                                @endif
