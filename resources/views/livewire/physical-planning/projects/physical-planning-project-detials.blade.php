...
@section('action-btn')
    <div class="float-end">
        ...
        @endcan
        @can('edit project')
            <a href="#" data-size="lg" data-bs-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#uploadBOQModal" title="{{__('Upload Bill of Quantity')}}" class="btn btn-sm btn-primary">
