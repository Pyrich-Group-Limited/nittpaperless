                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0"><a href="{{ route('pp.projects.show',$project) }}" class="name mb-0 h6 text-sm">{{ $project->project_name }}</a></p>
                                    </div>
                                </td>

                                <td class="">
                                    <span class="badge bg-info p-2 px-3 rounded">{{ $project->status }}</span>@if($project->project_boq==null) <span class="badge bg-danger p-2 px-3 rounded">Pending BOQ</span> @endif
                                </td>
                                <td class="">
