...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"> {{ $folders->first()->owner->name }}</li>
@endsection
                                ...
                                <div class="card-header-right">
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('employees.folders',[$folder->owner->id,$folder->folder_type]) }}"  class="dropdown-item">
                                                <i class="ti ti-eye"></i>
                                                <span> {{__('View')}}</span>
                                            </a>
                            ...
                            <div class="card-body s">
                                <div class="img-fluid rounded-circle card-avatar">
                                    ...
                                    <span class="nk-file-icon-type">
                                        @if($folder->folder_type=="Secrete")
                                            <img src="{{ asset('uploads/private.png')}}" width="80" />
                                        @else
                                    ...
                                    <h6 class=" mt-4 text-primary">{{ $folder->folder_type }} File</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
