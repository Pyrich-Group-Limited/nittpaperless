...
<div>
                        ...
                        <div class="card text-center card-2">
                                ...
                                <div class="card-header-right">
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('employees.subfile',$folder->owner->id) }}"  class="dropdown-item">
                                                <i class="ti ti-eye"></i>
                                                <span> {{__('View')}}</span>
                                            </a>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="img-fluid rounded-circle card-avatar">
                                    <a href="{{ route('employees.subfile',$folder->owner->id)}}">
                                    ...
                                    <h6 class=" mt-4 text-primary">{{ $folder->owner->name }}</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    @include('livewire.employees.modals.new-folder-modal')
</div>
