<div id="createUser">
    <div class="modal" id="newDesignation" tabindex="-1" role="dialog" wire:ignore.self>
        <div class="modal-dialog modal-lg" role="document" wire:ignore.self>
            <div class="modal-content">
                <div class="modal-body">

                    <div class="modal-header">
                        <h5 class="modal-title" id="applyLeave">Designation Creation
                        </h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                    ...
                    <div class="modal-footer">
                        <div wire:loading wire:target="addDesignation"><x-g-loader /></div>
                        <input type="button" id="closeUserModal" value="{{ __('Cancel') }}" class="btn  btn-light"
                            data-bs-dismiss="modal">
                        <input type="button" wire:click="addDesignation" value="{{ __('Create') }}" class="btn  btn-primary">
                    </div>
                </div>
            </div>
        </div>
