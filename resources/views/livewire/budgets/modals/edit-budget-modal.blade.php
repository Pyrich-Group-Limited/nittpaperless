<div id="createUser">
    <div class="modal" id="updateBudgetCategory" tabindex="-1" role="dialog" wire:ignore.self>
        <div class="modal-dialog modal-lg" role="document" wire:ignore.self>
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-header">
                        <h5 class="modal-title">Modify Budget Module</h5>
                    </div>
                    <div class="modal-body">
                        @if ($selBudget)
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="year" class="form-control" wire:model="year">
                                        ...
                                        {{-- <option value="{{ $selBudget->year }}" disabled selected>{{ $selBudget->year }}</option> --}}
                    ...
                    <div class="modal-footer">
                        <div wire:loading wire:target="updateBudgetCategory"><x-g-loader /></div>
                        <input type="button" id="closeBudgetUpdateModal" value="{{ __('Cancel') }}" class="btn  btn-light"
                            data-bs-dismiss="modal">
                        <input type="button" wire:click="updateBudgetCategory" value="{{ __('Update') }}"
...
<script>
    window.addEventListener('success', event => {
        document.getElementById("closeBudgetUpdateModal").click();
    })
</script>
