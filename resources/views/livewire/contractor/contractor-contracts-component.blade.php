<div>
    ...
    @section('breadcrumb')
        ...
        <li class="breadcrumb-item">{{__('My Contracts')}}</li>
    @endsection
                        ...
                        <div class="table-responsive">
                            <table class="table datatable">
                                ...
                                @foreach ($contracts as $contract)
                                    ...
                                    <tr class="font-style">
                                        <td>
                                            <a href="{{route('contractor.contractDetails',$contract->id)}}" class="btn btn-outline-primary">{{\Auth::user()->contractNumberFormat($contract->id)}}</a>
                                        </td>
                                        ...
                                        <td class="action ">
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('contractor.contractDetails',$contract->id) }}"
