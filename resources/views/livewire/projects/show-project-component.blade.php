...
@section('action-btn')
    <div class="float-end">
        ...
        @can('edit project')
        <a href="#" data-size="lg" data-bs-toggle="modal" data-bs-target="#publishAdvertModal" id="toggleOldProject" wire:click="selProject2({{$project}})"  data-bs-toggle="tooltip" title="{{__('Advertise Project')}}"  class="btn btn-sm btn-primary">
            <i class="ti ti-share"></i>
        </a>

        <a href="#" data-size="lg" data-bs-toggle="modal" data-bs-target="#editProject" id="toggleOldProject"  wire:click="selProject({{$project->id}})"  data-bs-toggle="tooltip" title="{{__('Modify Project')}}"  class="btn btn-sm btn-primary">
