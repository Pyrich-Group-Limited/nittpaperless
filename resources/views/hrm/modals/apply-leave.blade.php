                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" value="{{ old('start_date')}}" class="form-control" placeholder="Date" required>
                                @error('start_date')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="end_date" value="{{ old('end_date')}}" class="form-control" placeholder="Date" required>
                                @error('end_date')
                                <small class="invalid-password" role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </small>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="reason" class="form-control" role="5">{{ old('reason') }}</textarea>
                                @error('reason')
                                <small class="invalid-password" role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </small>
