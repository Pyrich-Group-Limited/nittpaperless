...
<body>
    <div class="memo-wrapper">
        ...
        <table class="header-table">
            <tr>
                <td class="logo">
                    <img src="{{ public_path('assets/images/logo-dark.png') }}" width="100%">
                </td>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="8" style="border-collapse: collapse; margin-top: 20px;">
            <tr style="background-color: #f2f2f2;">
                <th colspan="2" align="left">Signatures</th>
            </tr>
        
            @if ($memo->signedUsers->isEmpty())
                <tr>
                    <td colspan="2">No signatures yet.</td>
                </tr>
            @else
                @foreach ($memo->signedUsers as $user)
                    <tr>
                        <td width="30%">
                            ...
                            <small>{{ $user->designation ?? 'No Title' }}</small>
                        </td>
                        <td>
