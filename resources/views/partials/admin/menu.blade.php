            ...
            @if(\Auth::user()->type != 'client')
                <ul class="dash-navbar">
                    ...
                    @if( Gate::check('manage product & service') || Gate::check('manage product & service'))
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext">{{__('Assets/Store')}}</span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="dash-submenu">
                    ...
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'procurement-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-procurement"></i></span><span class="dash-mtext">{{__('e-Procurement')}}</span>
                        </a>
                    </li>

                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'business-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext">{{ __('BIS Development') }}</span></a>
                    </li>
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'supply-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext">{{ __('SCMS Development') }}</span></a>
                    </li>
                    
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'marketing-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext">{{ __('MRM Module') }}</span></a>
                    </li>
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'planning-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext">{{ __('DAP System') }}</span></a>
                    </li>
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'risk-templates')?'active':''}}">
                        <a href="" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-template"></i></span>
                            <span class="dash-mtext">{{ __('DIRM System') }}</span></a>
                    </li>
