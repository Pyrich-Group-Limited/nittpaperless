...
@section('page-title')
    {{__('Delivered Supply Details')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('deliveredSupply.list') }}">{{__('Delivered Supply')}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('deliveredSupply.details') }}">{{__('Delivered Supply Details')}}</a></li>
@endsection
