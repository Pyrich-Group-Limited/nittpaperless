...
@section('page-title')
    {{__('Approved Supply Details')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('approvedSupply.list') }}">{{__('Approved Supply')}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('approvedSupply.details') }}">{{__('Approved Supply Details')}}</a></li>
@endsection
