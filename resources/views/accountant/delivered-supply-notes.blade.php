...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('deliveredSupply.list') }}">{{__('Delivered Supplys ')}}</a></li>
@endsection
                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="{{ route('deliveredSupply.details') }}" class="mx-3 btn btn-sm align-items-center"
